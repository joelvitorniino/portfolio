        ...
        <div className="bg-gray-200 p-8">
            ...
            <div className="mt-4">
                <p className='text-xl font-semibold'>
                    Olá me chamo Joel Vitor, tenho 16 anos e estou em busca de uma oportunidade na programação! Já estudo programação a 3 anos.
                </p>
            </div>
            <div className="mt-4">
                ...
                <span className='flex m-2'>
                    ...
                    <p className='inline ml-2 font-bold'>
                        TypeScript - <span className='font-extrabold'> (Intermediário)</span>
                    </p>
                </span>
